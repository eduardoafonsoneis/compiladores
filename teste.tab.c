...
{
  "$end", "error", "$undefined", "INTEGER", "FLOAT", "CHAR", "VIRGULA",
  "FIMDECL", "ID", "$accept", "start", "idstream", "tipo", YY_NULLPTR
};
#endif
